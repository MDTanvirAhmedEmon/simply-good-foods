    ...
    <div style={bgImage}>
      <div className="container mx-auto flex h-full items-center">
        ...
        <div className="w-1/2 py-16">
          ...
          >
            <div>
                <h2 className="text-center text-2xl font-semibold mb-2 text-slate-600">Log In</h2>
                <p className="text-center text-sm text-slate-500">Please enter your email and password to continue</p>
            </div>
